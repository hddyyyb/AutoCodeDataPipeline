...
The `domain_map.json` file is an intermediate artifact generated during
the pipeline execution. It captures structured knowledge extracted from
the repository and serves as input for downstream QA and Design generation.
